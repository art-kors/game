...
def show_go_screen():
    ...
    draw_text(screen, f'max score {mx}', 32, 240, 400)
    pygame.display.flip()
    waiting = True
    while waiting:
...
shield_sound = pygame.mixer.Sound(path.join(snd_dir, 'pow4.mp3'))
power_sound = pygame.mixer.Sound(path.join(snd_dir, 'pow4.mp3'))
expl_sounds = []
...
def game():
    global score, mx, all_sprites, mobs, bullets
